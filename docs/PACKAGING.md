...
- `clients/android/app/build.gradle.kts`: `versionName = "0.29.0"`, `versionCode` incremented
- `crates/orbiscreen-gui/tauri.conf.json`: `"version": "0.29.0"`
- `PKGBUILD`: `pkgver=0.29.0`
- `debian/changelog`: new entry for `0.29.0-1`
- `data/orbiscreen-copr.spec`: `Version: 0.29.0`
- `Cargo.toml`: `[workspace.package].version = "0.29.1"`
- `clients/android/app/build.gradle.kts`: `versionName = "0.29.1"`, `versionCode` incremented
- `crates/orbiscreen-gui/tauri.conf.json`: `"version": "0.29.1"`
- `PKGBUILD`: `pkgver=0.29.1`
- `debian/changelog`: new entry for `0.29.1-1`
- `data/orbiscreen-copr.spec`: `Version: 0.29.1`
- `Cargo.toml`: `[workspace.package].version = "0.30.0"`
- `clients/android/app/build.gradle.kts`: `versionName = "0.30.0"`, `versionCode` incremented
- `crates/orbiscreen-gui/tauri.conf.json`: `"version": "0.30.0"`
- `PKGBUILD`: `pkgver=0.30.0`
- `debian/changelog`: new entry for `0.30.0-1`
- `data/orbiscreen-copr.spec`: `Version: 0.30.0`
...
The release matrix is: `0.29.0` (workspace), `versionCode = 103` (Android). The Android release keystore is no longer shipped in the repo (see SECURITY.md); supply `ORBISCREEN_KEYSTORE_PATH`/`ORBISCREEN_STORE_PASSWORD`/`ORBISCREEN_KEY_ALIAS`/`ORBISCREEN_KEY_PASSWORD` when building a release APK.
The release matrix is: `0.29.1` (workspace), `versionCode = 104` (Android). The Android release keystore is no longer shipped in the repo (see SECURITY.md); supply `ORBISCREEN_KEYSTORE_PATH`/`ORBISCREEN_STORE_PASSWORD`/`ORBISCREEN_KEY_ALIAS`/`ORBISCREEN_KEY_PASSWORD` when building a release APK.
The release matrix is: `0.30.0` (workspace), `versionCode = 105` (Android). The Android release keystore is no longer shipped in the repo (see SECURITY.md); supply `ORBISCREEN_KEYSTORE_PATH`/`ORBISCREEN_STORE_PASSWORD`/`ORBISCREEN_KEY_ALIAS`/`ORBISCREEN_KEY_PASSWORD` when building a release APK.
