...
cargo fmt --all
git add -A
git commit -m "orbiscreen | v0.23.9 | style: cargo fmt --all"
```
...
git add -A
git commit -m "orbiscreen | v0.23.9 | fix: resolve clippy warnings"
```
...
git add Cargo.lock
git commit -m "orbiscreen | v0.23.9 | chore: refresh Cargo.lock"
```
...
**Fix:**
Update to the latest release (v0.23.9 or newer).
