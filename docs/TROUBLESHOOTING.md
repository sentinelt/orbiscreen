...
cargo fmt --all
git add -A
git commit -m "orbiscreen | v0.23.7 | style: cargo fmt --all"
git commit -m "orbiscreen | v0.23.8 | style: cargo fmt --all"
```
...
git add -A
git commit -m "orbiscreen | v0.23.7 | fix: resolve clippy warnings"
git commit -m "orbiscreen | v0.23.8 | fix: resolve clippy warnings"
```
...
git add Cargo.lock
git commit -m "orbiscreen | v0.23.7 | chore: refresh Cargo.lock"
git commit -m "orbiscreen | v0.23.8 | chore: refresh Cargo.lock"
```
...
**Fix:**
Update to the latest release (v0.23.7 or newer).
Update to the latest release (v0.23.8 or newer).
