...
cargo fmt --all
git add -A
git commit -m "orbiscreen | v0.24.0 | style: cargo fmt --all"
git commit -m "orbiscreen | v0.24.1 | style: cargo fmt --all"
```
...
git add -A
git commit -m "orbiscreen | v0.24.0 | fix: resolve clippy warnings"
git commit -m "orbiscreen | v0.24.1 | fix: resolve clippy warnings"
```
...
git add Cargo.lock
git commit -m "orbiscreen | v0.24.0 | chore: refresh Cargo.lock"
git commit -m "orbiscreen | v0.24.1 | chore: refresh Cargo.lock"
```
...
**الإصلاح:**
حدّث إلى الإصدار الأخير (v0.24.0 أو أحدث).
حدّث إلى الإصدار الأخير (v0.24.1 أو أحدث).
