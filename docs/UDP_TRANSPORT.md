...
[![Version](https://img.shields.io/badge/version-0.28.8-2563eb?style=flat-square&logo=semver)](../CHANGELOG.md)
[![Version](https://img.shields.io/badge/version-0.28.9-2563eb?style=flat-square&logo=semver)](../CHANGELOG.md)
...
Android streams H.264 access units over UDP. The web client uses WebTransport Annex-B (`signaling_port + 2`, advertised as `wt_port`) and WebCodecs `VideoDecoder`. HTTP MPEG-TS on `/stream` stays as the Android USB/AOA fallback.
