...
[![الإصدار](https://img.shields.io/badge/version-0.30.5-2563eb?style=flat-square&logo=semver)](../CHANGELOG.md)
...
- **الشاشة الافتراضية:** أصلية عبر `zkde_screencast_unstable_v1` أو XDG Portal ScreenCast `SourceType::Virtual`. بلا root،
  بلا وحدة نواة، بلا نافذة مشاركة. تظهر الشاشة عند اتصال العميل: الاسم الظاهر هو اسم الجهاز، والموصّل `Virtual-Orbi-<key>` ثابت لكل جهاز حتى يتذكّر KWin الموضع والمقياس.
...
> الشاشة الافتراضية تبدأ **فارغة** (خلفية سطح المكتب فقط)، هذا معنى الشاشة الثانية. اسحب النوافذ إلى مخرج ذلك العميل (`Virtual-Orbi-<الجهاز>` على KDE)، أو استخدم `mirror` لبث شاشتك الفعلية.
