...
- **PKGBUILD**: Bumped `pkgver` to `0.28.0`.
- **debian/changelog**: Added `0.28.0-1` release entry for Ubuntu noble.
- **data/orbiscreen-copr.spec**: Bumped version to `0.28.0` and added changelog entry.
